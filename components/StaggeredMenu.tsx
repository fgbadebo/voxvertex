...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  menuButtonColor = "#2888b2",
  openMenuButtonColor = "#22888b2",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header shadow-lg fixed top-0 left-0 w-full flex items-center justify-between p-8 md:p-16 bg-background pointer-events-none z-20"
          aria-label="Main navigation header"
        >
          <div
            className="relative w-10 h-12 flex items-center select-none pointer-events-auto"
            aria-label="Logo"
          >
            <Image
        ...
        <aside
          ...
          ref={panelRef}
          // CHANGED: absolute -> fixed
          className="staggered-menu-panel fixed top-0 right-0 h-full bg-[#ebf9ff] flex flex-col overflow-y-auto z-10 backdrop-blur-[12px] pointer-events-auto"
                ...
                >
                  {socialItems.map((s, i) => (
                    <li key={s.label + i} className="sm-socials-item">
                      <Link
                        href={s.link}
                        className="sm-socials-link text-[1.2rem] font-medium text-[#111] no-underline relative inline-block py-[2px] transition-[color] duration-300 ease-linear"
                      >
                        {s.label}
                      </Link>
                    </li>
...
.sm-scope .staggered-menu-header { position: fixed; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 1em 2em; background: #ffffff; pointer-events: none; z-index: 20; }
...
.sm-scope .sm-socials-list .sm-socials-link { opacity: 1; transition: color 0.3s ease; }
...
.sm-scope .sm-panel-item { position: relative; color: #000; font-weight: 600; font-size: 3rem; cursor: pointer; line-height: 1; letter-spacing: -2px; text-transform: uppercase; transition: background 0.25s, color 0.25s; display: inline-block; text-decoration: none; padding-right: 0em; }
