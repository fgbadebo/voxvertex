...
export default function TrendingBlogs() {
  return (
    <section
      id="services"
      className="relative w-full max-w-7xl mx-auto flex flex-col items-center justify-center px-4 md:px-6 lg:px-12 xl:px-4 py-20 gap-12 lg:gap-8 xl:gap-12"
    >
      ...
      >
        <Link
          href={"/blogs"}
          className="px-6 py-3 bg-primary text-background rounded-full text-base border border-primary hover:text-primary hover:bg-transparent transition-all duration-300"
        >
          View all Blogs
        </Link>
      </AnimatedContent>
