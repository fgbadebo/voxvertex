...
export default function Register() {
  return (
    <main className="relative w-full min-h-dvh flex items-center justify-center lg:justify-end overflow-hidden pt-20 md:pt-20 lg:pt-18 xl:pt-24 lg:pr-18 xl:pr-24">
      ...
      <section className="flex flex-col w-9/10 md:w-4/5 lg:basis-[42%] bg-background rounded-xl md:rounded-2xl lg:rounded-xl xl:rounded-2xl px-8 md:px-16 lg:px-12 xl:px-20 py-12 md:py-14 lg:py-12 xl:py-14 gap-8">
        ...
        >
          ...
          <Link href={'/login'} className="-mt-2 self-end text-sm md:text-base lg:text-sm xl:text-base text-primary hover:opacity-75 transition-all duration-300">Already registered? Login</Link>
